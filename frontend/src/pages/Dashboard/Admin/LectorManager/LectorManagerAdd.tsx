...
const LectorManagerAdd = () => {
    ...
    const onFormSubmit = (data: Omit<Lector, "id"> & { password: string }) => {
        setLoading(true)
        setError(false)
        ...
        value.createLector(data).then(data => {
            navigate(RouteHandles.LECTOR_MANAGER)
        }).catch(e => {
            setError(true)
            console.error(e)
        }).finally(() => {
    ...
    return <ContentLayout goBack title="Přidat lektora">
...
export default LectorManagerAdd