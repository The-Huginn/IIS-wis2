...
import { AuthContext, AuthContextValueType, ErrorContext } from "@root/exports"
...
const App = () => {
    ...
    return <AuthContext.Provider value={{
        ...
        <ErrorContext.Provider value={{
            ...
            {<Toast bg="danger" onClose={() => setError(false)} show={error} style={{ zIndex: 999999, position: "absolute", right: "1rem", bottom: "1rem" }}>
                <Toast.Header>
                    <strong className="me-auto">Chyba!</strong>
                </Toast.Header>
                <Toast.Body>Došlo k chybě při tvorbě požadavku. Obnovte prosím stránku a zkuste to znovu.</Toast.Body>
            </Toast>}
